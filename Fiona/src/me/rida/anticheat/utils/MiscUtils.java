...
public class MiscUtils {
    ...
    public static boolean hasPermissionForAlerts(Player player) {
        return player.hasPermission("anticheat.staff") || player.hasPermission("anticheat.alerts");
    }
    ...
    public static String formattedMessage(String message) {
        return Color.translate(AntiCheat.getInstance().getMessageFields().prefix + message);
    }
    ...
    public static void printToConsole(String string) {
        AntiCheat.getInstance().consoleSender.sendMessage(Color.translate(string));
    }
}
