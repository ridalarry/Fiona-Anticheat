...
public class MathUtils {
    ...
    public static boolean moved(AntiCheatLocation from, AntiCheatLocation to) {
        return playerMoved(from, to);
    }

    public static boolean looked(AntiCheatLocation from, AntiCheatLocation to) {
    ...
    public static boolean playerMoved(AntiCheatLocation from, AntiCheatLocation to) {
        return playerMoved(from.toVector(), to.toVector());
    }
    ...
    public static boolean playerLooked(AntiCheatLocation from, AntiCheatLocation to) {
        return (from.getYaw() - to.getYaw() != 0) || (from.getPitch() - to.getPitch() != 0);
    }
    ...
    public static double getHorizontalDistance(AntiCheatLocation from, AntiCheatLocation to) {
        double deltaX = to.getX() - from.getX(), deltaZ = to.getZ() - from.getZ();
        return Math.sqrt(deltaX * deltaX + deltaZ * deltaZ);
    }
    ...
    public static double getVerticalDistance(AntiCheatLocation from, AntiCheatLocation to) {
        return Math.abs(from.getY() - to.getY());
    }
