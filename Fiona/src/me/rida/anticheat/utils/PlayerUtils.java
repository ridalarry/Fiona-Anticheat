...
public class PlayerUtils {
    ...
    public static boolean isGliding(Player p) {
        return AntiCheat.getInstance().getBlockBoxManager().getBlockBox().isGliding(p);
    }
    ...
    public static double getAccurateDistance(AntiCheatLocation origin, AntiCheatLocation point) {
