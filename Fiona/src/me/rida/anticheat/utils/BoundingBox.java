...
public class BoundingBox {
    ...
    public List<BoundingBox> getCollidingBlockBoxes(Player player) {
        return AntiCheat.getInstance().getBlockBoxManager().getBlockBox().getCollidingBoxes(player.getWorld(), this);
    }
    ...
    public List<Block> getCollidingBlocks(Player player) {
        ...
        AntiCheat.getInstance().getBlockBoxManager().getBlockBox().getCollidingBoxes(player.getWorld(), this).forEach(bb -> bb.getMinimum().toLocation(player.getWorld()).getBlock());
        return toReturn;
    }
