...
public class LagArgument extends FunkeArgument {
    ...
    public LagArgument() {
        super("lag", "lag [gc]", "accurately view your server's resources.", "anticheat.lag");
    ...
    public void onArgument(CommandSender sender, Command cmd, String[] args) {
        if (args.length == 1) {
            ...
            sender.sendMessage(Color.translate("&eTPS&7: &f" + MathUtils.round(AntiCheat.getInstance().tps, 2)));
