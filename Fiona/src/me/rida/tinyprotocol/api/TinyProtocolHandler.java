...
public class TinyProtocolHandler {
    ...
    public TinyProtocolHandler() {
        ...
        instance = ProtocolVersion.getGameVersion().isBelow(ProtocolVersion.V1_8) ? new TinyProtocol1_7(AntiCheat.getInstance()) {
            @Override
        ...
        } : new TinyProtocol1_8(AntiCheat.getInstance()) {
            @Override
    ...
    public Object onPacketOutAsync(Player sender, Object packet) {
        ...
        if(packetName.contains("Position")) {
            PlayerData data = AntiCheat.getInstance().getDataManager().getPlayerData(sender);
